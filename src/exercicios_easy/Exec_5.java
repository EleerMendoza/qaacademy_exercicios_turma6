...
public class Exec_5 {
    ...
    public int soma (int num, int num1, int num2) {
        return num+num1+num2;
    }

    public int sub (int num, int num1, int num2) {
        return num-num1-num2;

    }

    public int multi (int num, int num1, int num2) {
        return num*num1*num2;

    }

    public int media (int num, int num1, int num2) {
